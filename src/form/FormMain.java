...
public class FormMain extends JFrame implements DocumentListener {
    ...
    private void initComponents() {
        ...
        jLabel9.setText("Vracen kusur u aponenima:");
    ...
    private void btnMakeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMakeActionPerformed
        try {
            checkEnoughMoney();
            Map<String, Integer> map = nodeHandler.handle(Integer.parseInt(txtReturns.getText().trim()));
            txt100.setText(map.get("100") + "");
            txt50.setText(map.get("50") + "");
            txt20.setText(map.get("10") + "");
            txt1.setText(map.get("1") + "");
            JOptionPane.showMessageDialog(this, "Uspesno spremljena kafa!", "Kafa", JOptionPane.INFORMATION_MESSAGE);
        }  catch (NumberFormatException ex) {
            JOptionPane.showMessageDialog(this, "Niste uneli validan iznos novca!", "Greska:", JOptionPane.ERROR_MESSAGE);
        } catch (Exception ex) {
    ...
    private void setReturns() throws NumberFormatException {
        try {
            int coffePrice = Integer.parseInt(txtPrice.getText());
            int insertedAmount = Integer.parseInt(txtAmount.getText());

            int change = insertedAmount - coffePrice;
    ...
    private void checkEnoughMoney() throws Exception {
        if (txtAmount.getText().isEmpty()) {
            throw new Exception("Niste uneli novac!");
        }
        int insertedAmount = Integer.parseInt(txtAmount.getText().trim());
        int selectedCoffePrice = Integer.parseInt(txtPrice.getText().trim());

        if (insertedAmount < selectedCoffePrice) {
            throw new Exception("Niste uneli dovoljno novca!");
        }
    }
}
